...
const AirCompressorSystemDiagram = ({ data }) => {
  const {
    no1AirCompressor,
    no2AirCompressor,
    no1Dg,
    ...
    >
      ...
      <g id="layer1">
        ...
        <path
          id="circle147"
          className={
            typeof no2Dg?.item2?.value === "number"
              ? no2Dg?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
        ...
        <path
          id="path44"
          className={
            typeof no3Dg?.item2?.value === "number"
              ? no3Dg?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
        ...
        <path
          id="path63"
          className={
            typeof no1Dg?.item2?.value === "number"
              ? no1Dg?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
        ...
        <path
          id="path64"
          className={
            typeof no4Dg?.item2?.value === "number"
              ? no4Dg?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
        ...
        >
          <tspan id="tspan64" x={99.354355} y={206.8295}>
            {no1AirCompressor?.item1?.title ?? "RUNNING"}
          </tspan>
        </text>
        <path
          id="path65"
          className={
            typeof no1AirCompressor?.item1?.value === "number"
              ? no1AirCompressor?.item1?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
          }
        ...
        >
          <tspan id="tspan65" x={99.354355} y={228.04271}>
            {no1AirCompressor?.item2?.title ?? "COMMON ALARM"}
          </tspan>
        </text>
        <path
          id="path66"
          className={
            typeof no1AirCompressor?.item2?.value === "number"
              ? no1AirCompressor?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
          }
        ...
        >
          <tspan id="tspan66" x={99.354355} y={772.96698}>
            {no2AirCompressor?.item1?.title ?? "RUNNING."}
          </tspan>
        </text>
        <path
          id="path67"
          className={
            typeof no2AirCompressor?.item1?.value === "number"
              ? no2AirCompressor?.item1?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
          }
        ...
        >
          <tspan id="tspan67" x={99.354355} y={794.18018}>
            {no2AirCompressor?.item2?.title ?? "COMMON ALARM"}
          </tspan>
        </text>
        <path
          id="path68"
          className={
            typeof no2AirCompressor?.item2?.value === "number"
              ? no2AirCompressor?.item2?.value
                ? "fill-success"
                : "fill-destructive"
              : "fill-primary/50"
          }
